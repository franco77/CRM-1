...
<footer class="main-footer">
    ...
    <strong><?= gettext('Copyright') ?> &copy; <?= SystemService::getCopyrightDate() ?> <a href="http://www.churchcrm.io" target="_blank"><b>Dong Nai Port</a>.</strong> <?= gettext('All rights reserved') ?>.
</footer>
