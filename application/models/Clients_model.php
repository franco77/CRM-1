...
class Clients_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        $sector = get_array_value($options, "sector");
        if ($sector) {
            $where = " AND FIND_IN_SET('$sector', $clients_table.sector)";
        }
